...
import { Calendar, Car, CreditCard, Clock, CheckCircle, Star, TrendingUp, MapPin } from 'lucide-react';
...
const CustomerDashboard = () => {
  ...
  const stats = [
    { label: 'Active Bookings', value: '3', icon: Calendar, color: 'blue' },
    { label: 'Total Rentals', value: '12', icon: Car, color: 'green' },
    { label: 'Total Spent', value: '$2,450', icon: CreditCard, color: 'purple' },
    { label: 'Loyalty Points', value: '1,250', icon: Star, color: 'orange' }
  ];
