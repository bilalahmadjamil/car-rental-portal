...
const BookingModal = ({ isOpen, onClose, vehicle, mode, selectedDates }: BookingModalProps) => {
  ...
  useEffect(() => {
    if (isOpen && mode === 'rental' && formData.startDate && formData.endDate) {
      checkAvailability();
    }
  }, [isOpen, mode, formData.startDate, formData.endDate]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response && response.success) {
        ...
        // Wait for success message to be shown, then navigate back
        setTimeout(() => {
          // Reset form data
          setFormData({
            startDate: '',
  ...
  return (
    <>
      ...
      {/* Auth Modal - Outside AnimatePresence to avoid key conflicts */}
      <AuthModal
